package com.sah.shardingSphere.lock.core;


import com.google.common.base.Preconditions;
import com.sah.shardingSphere.lock.core.strategy.RedissonConfigStrategy;
import com.sah.shardingSphere.lock.core.strategy.impl.ClusterRedissonConfigStrategyImpl;
import com.sah.shardingSphere.lock.core.strategy.impl.MasterslaveRedissonConfigStrategyImpl;
import com.sah.shardingSphere.lock.core.strategy.impl.SentinelRedissonConfigStrategyImpl;
import com.sah.shardingSphere.lock.core.strategy.impl.StandaloneRedissonConfigStrategyImpl;
import com.sah.shardingSphere.lock.enums.RedisConnectionType;
...
public class RedissonManager {
    ...
    static class RedissonConfigFactory {
        ...
        private volatile static RedissonConfigFactory factory;
