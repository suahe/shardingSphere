 ...
 */
@Slf4j
public abstract class AbstractRedisDelayQueue implements ApplicationRunner {
     ...
     * 添加队列
     */
    public boolean addQueue(String message, long executionTime) {
        long delaySeconds = executionTime / 1000;
        return redisUtil.zAdd(this.setDelayQueueName(), message, delaySeconds);
    }
