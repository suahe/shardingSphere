package com.sah.shardingSphere.queue.trigger.impl;

import com.alibaba.fastjson.JSONObject;
import com.sah.shardingSphere.queue.delay.queue.CommonDelayQueue;
import com.sah.shardingSphere.queue.model.TimeTriggerMsg;
import com.sah.shardingSphere.queue.rocketmq.RocketmqSendCallbackBuilder;
...
import com.sah.shardingSphere.util.DateUtil;
import com.sah.shardingSphere.util.StringUtils;
...
public class RocketmqTimerTrigger implements TimeTrigger {
    ...
    @Autowired
    private CommonDelayQueue commonDelayQueue;
    ...
    public void addDelay(TimeTriggerMsg timeTriggerMsg) {
        ...
        this.redisUtil.set(generateKey, 1);
        //设置延时任务
        if (Boolean.TRUE.equals(commonDelayQueue.addJob(JSONObject.toJSONString(timeTriggerMsg), timeTriggerMsg.getTriggerTime()))) {
    ...
    public void delete(String executorName, Long triggerTime, String uniqueKey, String topic) {
        ...
        this.redisUtil.del(generateKey);
    }
}
