package com.sah.shardingshere.aspect;
...
import com.sah.shardingshere.util.IPUtil;
import com.sah.shardingshere.util.JwtUtil;
import com.sah.shardingshere.util.SpringContextUtil;
...
public class AutoLogAspect {
    ...
    @Pointcut("@annotation(com.sah.shardingshere.aspect.annotation.AutoLog)")
    ...
    private void saveSysLog(ProceedingJoinPoint joinPoint, long time, Object result) {
        ...
        //获取登录用户信息
        LoginDTO loginDTO = JwtUtil.getSysUserByToken();
        if (loginDTO != null) {
